  ...
  return (
    <>
      ...
      <Layout>
        ...
        <div className="faq_bg_a">
          <p>家財処分できます。まずは、フリーダイヤル（0120-28-3374）または、<a href="/contact/">お問い合わせフォーム</a>よりご連絡ください。現地にて下見・お見積もりする時、作業当日には、お立会いをお願いいたします。</p>
        </div>
        <p className="faq_bg_q">空き家の家財を処分してもらえませんか？</p>
        <div className="faq_bg_a">
          <p>空き家でも家財処分できます。まずは、フリーダイヤル（0120-28-3374）または、<a href="/contact/">お問い合わせフォーム</a>よりご連絡ください。現地にて下見・お見積もりする時、作業完了日には、お立会いをお願いいたします。空き家での作業となるため、作業期間中は鍵をお預かりいたします。（鍵の返却は作業完了日となります。）</p>
        </div>
        ...
        <div className="faq_bg_a">
          <p>お気軽にフリーダイヤル（0120-28-3374）または、<a href="/contact/">お問い合わせフォーム</a>よりご連絡ください。無料見積もりいたします。</p>
        </div>
