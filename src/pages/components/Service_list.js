...
const ServiceList = () => {
  return (
    <>
      <div className="bn_list img_100p"><img src="../../images/txt11.png" alt="安芸リサイクルのサービス一覧" /></div>
      ...
      <div className="service">
          ...
          <div className="service_inner">
            ...
            <div className="service_box">
              <div className="service_box_naka">
                <div className="center"><img src="../../images/top_pic01.png" alt="" /></div>
        ...
        <div className="service_cont">
          ...
          <div className="service_h">ゴミ屋敷の<br />片付け</div>
            <div className="service_box">
              <div className="service_box_naka">
                <div className="center"><img src="../../images/top_pic02.png" alt="" /></div>
        ...
        <div className="service_cont">
          ...
          <div className="service_h">遺品整理・<br />仏壇の引き取り</div>
            <div className="service_box">
              <div className="service_box_naka">
                <div className="center"><img src="../../images/top_pic03.png" alt="" /></div>
        ...
        <div className="service_cont">
          ...
          <div className="service_h">引っ越しに伴う<br />粗大ゴミ回収</div>
            <div className="service_box">
              <div className="service_box_naka">
                <div className="center"><img src="../../images/top_pic04.png" alt="" /></div>
                <p>ご家庭やオフィスにある要らなくなったものを即日回収いたします！</p>
