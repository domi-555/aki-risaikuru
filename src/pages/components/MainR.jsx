  ...
  return (
    <>
      <div id="main_r">
        ...
        <p><a href="/contact/" className="bt01">オンライン無料見積もり<FontAwesomeIcon icon={faCircleChevronRight} /></a></p>
        <p><a href="/voice/"><img src="../../images/side/side01.png" alt="お客様の声" width={320} height={100} /></a></p>
        <p><a href="/area/"><img src="../../images/side/side02.png" alt="対応エリア" width={320} height={100} /></a></p>
        <p><a href="/faq/"><img src="../../images/side/side03.png" alt="よくあるご質問" width={320} height={100} /></a></p>
        <p><a href="/flow/"><img src="../../images/side/side04.png" alt="ご利用までの流れ" width={320} height={100} /></a></p>
        <p><a href="https://aki-risaikuru.com/blog/"><img src="../../images/side/side05.png" alt="安芸リサイクルブログ" width={320} height={100} /></a></p>
        <p><img src="../../images/side/rakuten_01.png" width={320} height={175} /></p>
        <p className="center"><img src="../../images/side/ihin_seirisi_bn_2.png" alt="遺品整理士" width={200} height={245} /></p>
        <p className="center"><img src="../../images/side/tokusyu_seisou_bn.png" alt="当事業所には事件現場特殊清掃士の有資格者がいます。" width={200} height={77} /></p>
        <p className="center"><a href="http://www.is-mind.org/" target="_blank"><img src="../../images/side/side_04.gif" alt="遺品整理士認定協会" width={150} height={41} /></a></p>
        <p className="center"><img src="../../images/side/side_pic01.jpg" width={170} height={120} /></p>
